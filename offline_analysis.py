...
log_file = open("log_offline.txt", "w")
sys.stdout = log_file
txop_results = []
...
sniff(offline='capture1.pcap', prn=packet_callback)
...
with open("txop_results_offline.csv", "w", newline="") as csvfile:
...
print("Saved TXOP results to csv file")